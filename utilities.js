...
function startFromHash(){
    ...
    if (page != null){
        ...
        } else if (page == "brianmanker" || page == "copresence" || page == "forthebirds" || page == "jordanmowat" || page == "mountcarmel" || page == "valeriemilot" || page == "treeoflight" || page == "barbralica" || page == "fitzgeralds" || page == "neworford"){
