...
function startFromHash(){
    ...
    if (page != null){
        ...
        } else if (page == "lydiachristine" || page == "amyhillis" || page == "treeoflight2" || page == "mowatyates" || page == "leahy" || page == "caitlinwood" || page == "sammyjackson" || page == "lailabiali" || page == "pencilsalesman"){
